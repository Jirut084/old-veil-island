...
//            public string Text;
//            public float Timer;
//            public bool Blink;      // กระพริบหรือไม่
//            public float Alpha;     // สำหรับ Blink
//            public bool Visible;    // แสดงหรือไม่

//            public LogMessage(string text, float duration, bool blink = false)
//            {
//                Text = text;
//                Timer = duration;
//                Blink = blink;
...
//        private bool controlsShown = false; // ขึ้นครั้งเดียวต่อ StartGame
//        private bool reloadShown = false;   // R only once
...
//        public void Log(string text, float duration = 3f, bool blink = false)
//        {
//            messages.Add(new LogMessage(text, duration, blink));
//        }
...
//            // แสดง controls ขึ้นครั้งเดียว
//            if (!controlsShown &&
//                !gm.InMainMenu &&
//                !gm.CreditScene.Active &&
//                !gm.TutorialScene.Active &&
//                !gm.GameOverStarted &&
//                !gm.EndingActive)
//            {
//                controlsShown = true;
//                Log("W/A/S/D to walk", 20f, true);
//                Log("Shift to run", 20f, true);
//                Log("E to interact", 20f, true);
//                Log("Spacebar to open flashlight", 20f, true);
//                Log("1/2/3/4 to select", 20f, true);
//                Log("C to open/close book", 20f, true);
//                Log("Esc to pause", 20f, true);
//            }
...
//                if (msg.Blink)
//                {
//                    msg.Alpha = 0.5f + 0.5f * (float)Math.Sin(msg.Timer * 6f); // กระพริบจาง-ชัด
//                }
...
//                var msg = messages[i];
//                if (msg.Visible)
//                    sb.DrawString(gm.DefaultFont, msg.Text, new Vector2(10, startY + i * spacing), Color.Yellow * msg.Alpha);
//            }
//        }
